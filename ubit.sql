...
--
-- Host: localhost
-- Generation Time: Feb 08, 2014 at 03:27 PM
...
INSERT INTO `admin_login` (`username`, `password`, `is_admin`) VALUES
...
INSERT INTO `stu_login` (`epnum`, `password`, `full_name`, `father_name`, `field_name`, `semester`, `section`, `age`, `dob`, `doa`, `contact_no`) VALUES
