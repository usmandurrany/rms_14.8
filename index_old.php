...
<body>
    ...
    <div id="contentwrap">
        ...
        <div class="cleft">
            <h3>Student Login:</h3>
            <div id="sidebar">
                <form id="form_login" name="login" action="auth/includes/process.php" method="post">Enrolment No:
                    <br>
                    <input type="text" value="" name="epnum">
                    <br>Password:
                    <br>
                    <input type="password" value="" name="password">
                    <br>
                    <input id="form_submit_normal" type="submit" value="Login" name="login">
                </form>
            </div>

            <h3>Admin / Faculty Login</h3>
            <div id="sidebar">
                <form id="form_login" name="login" action="auth/includes/process.php" method="post">Username:
                    <br>
        ...
        <div class="cright">
            ...
            <h2>Announcements</h2>
            <?php $data=show_news('system'); while($news=mysql_fetch_array($data)){ echo '<div align="left">'.$news[2]. '</div>'; }?>
        </div>
    </div>
    <div class="clear"></div>
...
-->
            Design by
            <a href="http://www.facebook.com/usmandgreat">Usman Durrani</a>
        </div>
